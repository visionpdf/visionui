...
class FolerRepositoryImpl implements FolderRepository {
  ...
  Future<Either<Folder, Failure>> getFolder({String? filter, required int pageIndex}) async {
    AppFile file1 = AppFile(name: "file1.pdf", format: "pdf");
    AppFile file2 = AppFile(name: "file2.pdf", format: "pdf");
    ...
    // Folder folder4 = Folder(name: "folder1", folders: [folder2, folder3], files: [file2]);
    // Folder folder5 = Folder(name: "folder2", folders: [folder1, folder2, folder2, folder3, folder4], files: [file1]);
    // Folder folder6 = Folder(name: "folder3", folders: [folder1, folder2, folder2, folder3, folder4, folder5], files: [file2]);
